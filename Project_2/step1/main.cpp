...
int main(int argc, char **argv)
{
  ...
  */
  MemDesc md(
        particles.pos_x,        1,                      0,              // Postition in X
        particles.pos_y,        1,                      0,              // Postition in Y
        particles.pos_z,        1,                      0,              // Postition in Z
  ...
  {
    calculate_collision_velocity(particles, tmp_vel, N, dt);
    calculate_gravitation_velocity(particles, tmp_vel, N, dt);
    update_particle(particles, tmp_vel, N, dt);
